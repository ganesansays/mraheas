...
@Component({
  selector: 'app-education-department-schooling',
  templateUrl: './education-department-schooling.component.html',
  styleUrls: ['./education-department-schooling.component.css']
})
export class EducationDepartmentSchoolingComponent implements OnInit {
    ...
    ngOnInit(): void {
      this.studentsInfo.subscribe(result => {
        ...
        this.dataSource.filter = '{"term1Status" : "not approved"}';
      })
    }
